...
export default function Contact({ onPhone, onEmail, onLinkedIn }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setSnackbar({
        open: true,
        message: 'Failed to send message. Please try again later or contact me directly at shreyashsgowda2@gmail.com',
        severity: 'error'
      });
    } finally {
      setLoading(false);
                ...
                <Stack spacing={2.5} sx={{ flex: 1 }}>
                  ...
                  <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
                    ...
                    <Box>
                      ...
                      Kalasa,chikmagalur, Karnataka,Pincode 577124
                      </Typography>
                    </Box>
                  </Box>
                    ...
                    <Box>
                      ...
                      <Typography variant="body2" color="text.secondary">
                        <Button 
                          ...
                          onClick={() => window.open('https://wa.me/6363894617', '_blank')}
                        >
                          click here
                        </Button>
                      </Typography>
                  ...
                  <Box sx={{ 
                    ...
                    <iframe
                      width="100%"
                      src="https://www.google.com/maps?q=Kalasa,+Chikmagalur,+Karnataka+577124&output=embed"
                      height="100%"
                      style={{ border: 0 }}
                      allowFullScreen=""
                      loading="lazy"
                      referrerPolicy="no-referrer-when-downgrade"
                      title="Location Map - Kalasa, Chikmagalur"
                    />
                  </Box>
                </Stack>
              </CardContent>
